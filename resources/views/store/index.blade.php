...
@push('style')
    <style>
        ...
        >>>>>>>1091c0e7a11bdec2196f7c04fa97d81fe331366b .rating input {
            display: none;
        }
                    ...
                    <div class="arrival-section">
                        <div class="row g-5">
                            @forelse ($isProduct as $item)
                                <div class="col-lg-3 col-sm-6">
                                    <div class="product-wrapper" data-aos="fade-up">
                                        ...
                                        <div class="profile-content">
                                            <div class="profile-name-wrapper">
                                                <h5 class="profile-name mb-2">{{ $store->name }}</h5>
                                                <p class="profile-description opacity-75 mb-0">{{ '@' . $store->username }}
                                                </p>
                                                <div class="location mt-3">
                                                    <i class="fas fa-map-marker-alt"></i>
                                                    <span style="font-size: 16px;">{{ $store->address }}</span>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="location mt-2"> &nbsp;&nbsp;<span
                                                class="location mt-2">{!! $store->description !!}</span>
                                        </div>
                                    </div>
                                </div> <br> <br>
                                ...
                                @if (!$store->verified_at && auth()->id() === $store->user_id)
                                    <div class="alert alert-warning alert-dismissible fade show" role="alert"
                                        ...
                                        <p>Toko anda belum terverifikasi. Silahkan verifikasikan toko anda dari tautan yang
                                            sudah kami kirim ke
                                            surel anda.</p> <button type="button" class="btn-close"
                                    ...
                                    <ul class="nav nav-underline mb-3">
                                        <li class="nav-item">
                                            <a class="nav-link active" id="home-tab" data-bs-toggle="tab"
                                                ...
                                                aria-controls="home-tab-pane" aria-selected="true">Produk</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" id="lelang-tab" data-bs-toggle="tab"
                                                data-bs-target="#lelang-tab-pane" type="button" role="tab"
                                                aria-controls="lelang-tab-pane" aria-selected="false">Lelang</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" id="ulasan-tab" data-bs-toggle="tab"
                                                data-bs-target="#ulasan-tab-pane" type="button" role="tab"
                                                aria-controls="ulasan-tab-pane" aria-selected="false">Ulasan</a>
                                        </li>
                                    </ul>
                                    <div class="tab-content" id="myTabContent">
                                        <div class="tab-pane fade show active" id="home-tab-pane" role="tabpanel"
                                            ...
                                            <div class="arrival-section">
                                                <div class="row g-5">
                                                        ...
                                                        <div class="col-lg-3 col-sm-6">
                                                            <div class="product-wrapper" data-aos="fade-up">
                                                                ...
                                                                <div class="product-cart-btn">
                                                                    <a href="/user/keranjang" class="product-btn">Beli
                                                                        Sekarang</a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    @empty
                                                        <div class="col-lg-12">
                                                            ...
                                                            <p class="text-center">Maaf ya, kami masih belum menambahkan
                                                ...
                                                <div class="tab-pane fade" id="ulasan-tab-pane" role="tabpanel"
                                                    aria-labelledby="ulasan-tab" tabindex="0">
                                                    <ul class="list-group list-group-flush">
                                                        <li class="list-group-item d-flex mt-5 list-group-item-secondary rounded pt-3"
                                                            ...
                                                            <div class="w-100">
                                                                <div class="d-flex position-relative mb-4">
                                                                    ...
                                                                    <div class="ms-3 w-100">
                                                                        <div class="d-flex position-relative">
                                                                            <h5>Akbar</h5>
                                                                            <p class="position-absolute opacity-75"
                                                                                style="right: 0;">2 hari yang lalu</p>
                                                                            >>>>>>> 1091c0e7a11bdec2196f7c04fa97d81fe331366b
                                                                        </div>
                                                                    </div>
                                                                    <<<<<<< HEAD <div class="tab-pane fade"
                                                                        id="lelang-tab-pane" role="tabpanel"
                                                                        aria-labelledby="lelang-tab" tabindex="0">
                                                                        <div class="arrival-section">
                                                                            <div class="row g-5">
                                                                                ...
                                                                                @empty
                                                                                    <div class="col-lg-12">
                                                                                        <h3 class="text-center">Produk
                                                                                            Lelang Masih Kosong</h3>
                                                                                        <p class="text-center">Maaf ya,
                                                                                            kami masih belum menambahkan
                                                                                            produknya. Tapi dalam
                                                                                            waktu dekat kami
                                                                                            akan
                                                                ...
                                                                <div class="tab-pane fade" id="ulasan-tab-pane"
                                                                    role="tabpanel" aria-labelledby="ulasan-tab"
                                                                    tabindex="0">
                                                                    <ul class="list-group list-group-flush">
                                                                        <li class="list-group-item d-flex mt-5"
                                                                            style="height: 20rem">
                                                                            <div style="width: 30rem;">
                                                                                <img src="https://placehold.co/400"
                                                                                    class="img-fluid rounded mb-2"
                                                                            ...
                                                                            <div class="w-100">
                                                                                ...
                                                                                <p style="min-height: 5rem">Aku lupa aku
                                                                                    siapa</p>
                                                                            </div>
                                                                        </li>
                                                                        <li class="list-group-item d-flex mt-5"
                                                            ...
                                                            =======
                                                            <p class="border-top pt-2" style="min-height: 5rem">Aku lupa
                                                                aku siapa</p>
                                                </div>
                                                </li>
                        ...
                        @push('script')
                            <<<<<<< HEAD <script src="{{ asset('additional-assets/star-rating/dist/star-rating.min.js') }}"></script>
                            =======
