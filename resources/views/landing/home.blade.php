...
@section('content')
    ...
    <section class="product brand" style="position: relative; z-index: 100;background: #eee;" data-aos="fade-up">
        <div class="container pb-5 mb-5" style="z-index: 101;">
            ...
            <swiper-container slides-per-view="6" loop="true" navigation="false" space-between="30"
                ...
                @foreach ($brands as $brand)
                    <swiper-slide class="product p-0 border" style="border-radius: 20px;">
                        <div class="wrapper-img p-0">
