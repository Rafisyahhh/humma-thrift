          ...
          <swiper-container slides-per-view="4" loop="true" navigation="true" space-between="30" autoplay-delay="10000"
            ...
            @foreach ($product as $item)
              <swiper-slide id="cardButton"
                ...
                <div class="product-wrapper" data-aos="fade-up" isProduct>
                  <div class="product-img">
                    <img src="{{ asset("storage/$item->thumbnail") }}" alt="product-img" class="object-fit-cover">
                    <div class="product-cart-items">
                      <div class="product-cart-items">
                        @auth
                          <form action="{{ route('storesproduct', $item->id) }}" method="POST" favSubmit>
                            @csrf
                          ...
                          <form action="{{ route('storecart', $item->id) }}" method="POST" cartSubmit>
                            @csrf
                            <button class="favourite cart-item">
                              <span>
...
@push('js')
  ...
  <script>
    $("[data-route]:not(.submitLoading)").click(function({
      target: {
        tagName
      }
    }) {
