                ...
                <div class="row align-items-center gy-5">
                    ...
                    <div class="col-lg-6">
                        <div class="about-content" data-aos="fade-up">
                                    ...
                                    <li>
                                        <span>
                                            <svg width="25" height="25" viewBox="0 0 25 25" fill="none"
                                                ...
                                                <circle cx="12.5" cy="12.5" r="12.5" fill="#1C3879" />
                                                <path
                            ...
                            <a href="/detail-about" class="shop-btn">
                                Hubungi kami
                                <span>
    ...
    <section class="latest product footer-padding">
        <div class="container">
            <div class="section-title text-center">
                <h4 class="about-details">Berita Terbaru </h4>
            </div>
                ...
                <div class="row g-5">
                    <div class="col-lg-4 col-sm-6">
                        <div class="blogs-wrapper product-wrapper" data-aos="fade-up" data-aos-duration="300">
                            <div class="wrapper-img">
                                <img src="template-assets/front/assets/images/homepage-one/about/about-img-2.webp" alt>
                            </div>
                            <div class="wrapper-info">
                                ...
                                <a href="/detail-new" class="about-details wrapper-details">Top 10 Best
                                    Professional Blogging Platforms for 2022
                                </a>
                                <div class="divider"></div>
                                <a href="/detail-new" class="shop-btn">
                                    Learn More
                                    <span>
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <div class="blogs-wrapper product-wrapper" data-aos="fade-up" data-aos-duration="400">
                            <div class="wrapper-img">
                                <img src="template-assets/front/assets/images/homepage-one/about/about-img-3.webp" alt>
                            </div>
                            <div class="wrapper-info">
                                <div class="wrapper-data">
                                    <div class="admin wrapper-item">
                                ...
                                <a href="/detail-new" class="about-details wrapper-details">Logistics of
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <div class="blogs-wrapper product-wrapper" data-aos="fade-up" data-aos-duration="600">
                            <div class="wrapper-img">
                                <img src="template-assets/front/assets/images/homepage-one/about/about-img-4.webp" alt>
                            </div>
                            <div class="wrapper-info">
                                <div class="wrapper-data">
                                    <div class="admin wrapper-item">
                                ...
                                <a href="/detail-new" class="about-details wrapper-details">15 Best WordPress
            ...
            <div class="about-service-section">
                    ...
                    <div class="wrapper-img">
                        <span>
                            <svg width="104" height="104" viewBox="0 0 104 104" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <circle cx="52" cy="52" r="52" fill="rgba(28, 56, 121, 1)" />
                                <path
                ...
                <div class="about-wrapper">
                    ...
                    <div class="wrapper-info">
                        ...
                        <p>Nikmati belanja online tanpa repot dengan layanan kami! nikmati pengiriman cepat langsung ke
                            rumah Anda
                            ambang pintu.</p>
                    </div>
                </div>
