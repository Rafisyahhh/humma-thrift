...
@section('content')
  <div class="d-none fixed-top text-center">
    <p>Loading...</p>
  </div>
            ...
            <div class="row g-5" id="product-container">
              <div class="col-lg-12">
                <div class="product-sorting-section" style="padding-bottom: unset; margin-bottom: unset">
                  <div class="result">
                    <p>Menampilkan {{ $products->firstItem() }}–<span id="last-item">{{ $products->lastItem() }}</span>
                      dari
              ...
              @forelse ($products as $item)
                <div id="product-item" class="col-lg-4 col-sm-6" data-brand="{{ $item->brand->title }}"
...
{{-- <ul class="pagination mb-0 align-items-center">
  ...
  <li class="page-item"><a class="page-link" href="http://localhost:8000/product/regular?page=2">2</a></li>
  <li class="page-item"><a class="page-link" href="http://localhost:8000/product/regular?page=3">3</a></li>
  <li class="page-item"><a class="page-link" href="http://localhost:8000/product/regular?page=4">4</a></li>


  <li class="page-item">
    <a class="page-link" href="http://localhost:8000/product/regular?page=2" rel="next"
