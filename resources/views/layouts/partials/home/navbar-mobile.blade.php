      ...
      <span>
        <svg width="35" height="28" viewBox="0 0 35 28" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <path
            ...
            fill="#6E6D79"></path>
          <circle cx="26.9523" cy="8" r="8" fill="#1C3879"></circle>
          <path
              ...
              <span>
                <svg width="34" height="27" viewBox="0 0 34 27" fill="none"
                  ...
                  <path
                    ...
                    fill="white"></path>
                  <circle cx="25.9322" cy="8" r="8" fill="#1C3879"></circle>
                  <path
          ...
          <li class="category-list-item">
            <a href="product-sidebar.html">
              <div class="dropdown-item d-flex justify-content-between align-items-center">
                <div class="dropdown-list-item d-flex">
                  <span class="dropdown-img">
                    <img src="{{ asset('template-assets/front/assets/images/homepage-one/category-img/watch.webp') }}"
                      alt="watch">
                  </span>
                  <span class="dropdown-text">
                    Watches
          ...
          <li class="category-list-item">
            <a href="product-sidebar.html">
              <div class="dropdown-item d-flex justify-content-between align-items-center">
                <div class="dropdown-list-item d-flex">
                  <span class="dropdown-img">
                    <img src="{{ asset('template-assets/front/assets/images/homepage-one/category-img/glass.webp') }}"
                      alt="glass">
                  </span>
                  <span class="dropdown-text">
                    Sunglasses
