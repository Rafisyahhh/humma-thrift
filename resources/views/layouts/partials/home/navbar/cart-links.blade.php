    ...
    {{-- <div class="cart-submenu">
        <div class="cart-wrapper-item">
            @forelse ($carts as $item)
                <div class="wrapper">
                    <div class="wrapper-item">
                        <div class="wrapper-img" style="margin-right: 1rem; width: 80px; height: 80px; overflow: hidden;">
                            <img src="{{ asset('storage/' . $item->product->thumbnail) }}" alt="img" style="width: 100%; height: 100%; object-fit: cover;">
                        </div>
                        <div class="wrapper-content">
                            <h5 class="heading" style="font-size: 18px;">{{ $item->product->title }}</h5>
                            <div style="display: flex; align-items: center; margin-left: 0px;">
