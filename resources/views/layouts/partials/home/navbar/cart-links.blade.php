    ...
    <div class="cart-submenu">
        <div class="cart-wrapper-item">
            ...
            <div class="wrapper">
                <div class="wrapper-item">
                    <div class="wrapper-img">
                        <img src="{{ asset('template-assets/front/assets/images/homepage-one/product-img/product-img-2.webp') }}" alt="img">
                    </div>
                    <div class="wrapper-content">
            ...
            <div class="wrapper">
                <div class="wrapper-item">
                    <div class="wrapper-img">
                        <img src="{{ asset('template-assets/front/assets/images/homepage-one/product-img/product-img-3.webp') }}" alt="img">
                    </div>
                    <div class="wrapper-content">
            ...
            <div class="wrapper">
                <div class="wrapper-item">
                    <div class="wrapper-img">
                        <img src="{{ asset('template-assets/front/assets/images/homepage-one/product-img/product-img-4.webp') }}" alt="img">
                    </div>
                    <div class="wrapper-content">
        ...
        <div class="cart-wrapper-section">
            ...
            <div class="cart-btn">
                <a href="cart" class="shop-btn checkout-btn">Lihat</a>
            </div>
        </div>
    </div>
</div>
