            ...
            <li class="category-list-item">
              <a href="product-sidebar.html">
                <div class="dropdown-item d-flex justify-content-between align-items-center">
                  <div class="dropdown-list-item d-flex">
                    <span class="dropdown-img">
                      <img src="{{ asset('template-assets/front/assets/images/homepage-one/category-img/gift.webp') }}"
                        alt="gift">
                    </span>
                    <span class="dropdown-text">
                      Gifts
            ...
            <li class="category-list-item">
              <a href="product-sidebar.html">
                <div class="dropdown-item d-flex justify-content-between align-items-center">
                  <div class="dropdown-list-item d-flex">
                    <span class="dropdown-img">
                      <img src="{{ asset('template-assets/front/assets/images/homepage-one/category-img/ring.webp') }}"
                        alt="ring">
                    </span>
                    <span class="dropdown-text">
                      Gold Ring
              ...
              <a href="product-sidebar.html">
                <div class="dropdown-item d-flex justify-content-between align-items-center">
                  <div class="dropdown-list-item d-flex">
                    <span class="dropdown-img">
                      <img
                        src="{{ asset('template-assets/front/assets/images/homepage-one/category-img/baby.webp') }}"
                        alt="baby">
                    </span>
                    <span class="dropdown-text">
                      Baby Shop
