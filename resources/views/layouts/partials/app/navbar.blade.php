                ...
                <ul class="dropdown-menu dropdown-menu-end py-0">
                    ...
                    <li class="dropdown-notifications-list scrollable-container">
                        <ul class="list-group list-group-flush">
                                        ...
                                        <div class="flex-shrink-0 me-3">
                                            {{-- <div class="avatar">
                                                @if ($notification->data['avatar'])
                                                    <img src="{{ $notification->data['avatar'] }}" alt class="h-auto rounded-circle" />
                                                @else
                                                    <span class="avatar-initial rounded-circle {{ $notification->data['avatar_color'] }}">{{ $notification->data['avatar_initial'] }}</span>
                                                @endif
                                            </div> --}}
                                        </div>
                            ...
                            @empty
                                <li class="list-group-item list-group-item-action">No unread notifications</li>
                            @endforelse
                        </ul>
                    </li>
