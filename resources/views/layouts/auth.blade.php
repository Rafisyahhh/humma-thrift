...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=League+Spartan:wght@100..900&Inter:wght@100..900&family=Jost:ital,wght@0,100..900;1,100..900&family=Poppins:ital,wght@0,100;0,200;0,300;0,400;0,500;0,600;0,700;0,800;0,900;1,100;1,200;1,300;1,400;1,500;1,600;1,700;1,800;1,900&display=swap" rel="stylesheet" />
        ...
        <div class="header-center-section d-none d-lg-block">
            <div class="container">
                <div class="header-center">
                    <div class="logo">
                        <a href="{{ url('/') }}">
                            <img src="{{ asset('images/brands/png/logo-color-darkxxxhdpi.png') }}" alt="logo" style="height: 36px">
                        </a>
                    </div>
                </div>
            </div>
                                    ...
                                    <div class="icon">
                                        <span>
                                            <svg width="44" height="45" viewBox="0 0 44 45" fill="none"
                                                ...
                                                <circle cx="21.9995" cy="22.9961" r="20" stroke="#ffffff"></circle>
