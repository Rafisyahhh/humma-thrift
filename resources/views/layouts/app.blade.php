...
<html lang="en" class="light-style layout-navbar-fixed layout-menu-fixed layout-wide" dir="ltr"
    data-theme="theme-bordered" data-assets-path="template-assets/admin/assets/"
...
<head>
    ...
    <!-- Core CSS -->
    <link rel="stylesheet" href="template-assets/admin/assets/vendor/css/rtl/core.css" />
    <link rel="stylesheet" href="template-assets/admin/assets/vendor/css/rtl/theme-default.css" />
                                        ...
                                        <ul class="list-group list-group-flush">
                                            <li
                                                ...
                                                <div class="d-flex">
                                                    <div class="flex-shrink-0 me-3">
                                                        <div class="avatar">
                                                            <img src="template-assets/admin/assets/img/avatars/1.png"
                                            ...
                                            <li
                                                ...
                                                <div class="d-flex">
                                                    <div class="flex-shrink-0 me-3">
                                                        <div class="avatar">
                                                            <img src="template-assets/admin/assets/img/avatars/2.png"
                                                                alt class="h-auto rounded-circle" />
                                                        </div>
                                                    </div>
                                                    <div class="flex-grow-1">
                                            ...
                                            <li
                                                ...
                                                <div class="d-flex">
                                                    <div class="flex-shrink-0 me-3">
                                                        <div class="avatar">
                                                            <img src="template-assets/admin/assets/img/avatars/9.png"
                                                                alt class="h-auto rounded-circle" />
                                                        </div>
                                                    </div>
                                                    <div class="flex-grow-1">
                                            ...
                                            <li
                                                ...
                                                <div class="d-flex">
                                                    <div class="flex-shrink-0 me-3">
                                                        <div class="avatar">
                                                            <img src="template-assets/admin/assets/img/avatars/5.png"
                                                                alt class="h-auto rounded-circle" />
                                                        </div>
                                                    </div>
                                                    <div class="flex-grow-1">
                                            ...
                                            <li
                                                ...
                                                <div class="d-flex">
                                                    <div class="flex-shrink-0 me-3">
                                                        <div class="avatar">
                                                            <img src="template-assets/admin/assets/img/avatars/6.png"
                                                                alt class="h-auto rounded-circle" />
                                                        </div>
                                                    </div>
                                                    <div class="flex-grow-1">
                            ...
                            <li class="nav-item navbar-dropdown dropdown-user dropdown">
                                <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);"
                                    ...
                                    <div class="avatar avatar-online">
                                        <img src="template-assets/admin/assets/img/avatars/1.png" alt
