                                ...
                                <div class="profile-section">
                                    <div class="row g-5">
                                        @foreach ($transaction as $item)
                                            @php
                                                $transactionGrouped = $transaction
                                                ...
                                                <div class="product-wrapper" style="border: 1px solid; height: 17rem;">
                                                    <div class="wrapper-content" style="position: relative; height:13rem;">
                                                        <p class="paragraph mt-4 ms-4 fw-bold" style="font-size: 15px;">
                                                            {{ $item->user->name }}</p>
                                                        <p class="paragraph mt-4 ms-4 p-0" style="font-size: 15px;">Jumlah
                                                            produk : {{ $transactionGrouped[$item->transaction_id] ?? 0 }}
                                                        </p>
                                                        ...
                                                        <p class="paragraph ms-4 p-0" style="font-size: 15px;">Total Harga :
                                                        ...
                                                        <a
                                                            href="{{ route('seller.transaction.detail', $item->transaction_id) }}">
