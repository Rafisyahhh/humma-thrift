    ...
    <div class="heading">
      ...
      <form action="{{ url()->current() }}" class="form-group">
        ...
        <input type="text" id="trx-id" name="trx" class="form-control"
          value="{{ old('trx', request()->get('trx')) }}" placeholder="Misal: TRX-00001" style="font-size: 1rem" />
      ...
      @forelse ($transactions as $transaction)
        <div class="table-body">
          <div class="table-item flex-column d-flex">
            <a href="{{ route('seller.transaction.detail', $transaction->id) }}">{{ $transaction->transaction_id }}</a>
