    ...
    <form action="{{ route('seller.withdraw.issue') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group mb-3">
            ...
            <input type="number" style="font-size: 14px; padding: 1rem 1.5rem;"
                placeholder="Masukkan nominal yang akan anda tarik" value="{{ old('amount') }}" name="amount" id="amount" class="form-control @error('amount') is-invalid @enderror"
                required />
        ...
        <button class="btn btn-primary" style="font-size: 14px; padding: 1rem 1.5rem;" type="submit">Ajukan</button>
    </form>
@endsection
