        ...
        <div class="row g-0 h-100" style="max-height:82rem;">
          <div class="col-md-12 border-end list-group list-group-flush h-100 mt-5">
            ...
            @forelse ($notifications as $notification)
              ...
              <a class="list-group-item py-3 position-relative d-flex justify-content-between align-items-center">
                <div class="text ms-4" style="text-align:left;">
                  ...
                  @if (array_key_exists('data', $data))
                    <p class="mb-1 @if (!$notification->read_at) fw-bold @endif" style="font-size: 14px;">
                ...
                @isset($data['image'])
                  <div>
                    <button class="me-4" onclick="openModal('#exampleModal{{ $notification->id }}')" data-toggle="tooltip"
              ...
              @isset($data['image'])
                <div class="modal fade" id="exampleModal{{ $notification->id }}" tabindex="-1" role="dialog"
                  ...
                  <div class="modal-dialog" role="document">
                    <div class="modal-content-show1">
                      ...
                      <div class="modal-body">
                        <img src="{{ asset("storage/$data[image]") }}" alt="image" class="object-fit-cover">
                      </div>
                      <div class="modal-footer">
                        <button type="button" class="button1" data-dismiss="modal"
