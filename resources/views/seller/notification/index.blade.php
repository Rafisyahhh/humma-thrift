    ...
    <div class="col-md-12 h-100">
        <div class="card shadow-sm">
            <div class="card-header border-bottom d-flex gap-3 align-items-center justify-content-between bg-light">
                ...
                <a href="{{ route('seller.notification.readAll') }}" class="@if(auth()->user()->unreadNotifications->isEmpty()) disabled @endif btn btn-sm btn-light d-flex gap-2 align-items-center">
            ...
            <div class="row g-0">
                <div class="col-md-3 border-end">
                    <div class="list-group list-group-flush">
                        ...
                        @endphp
                        <a class="list-group-item py-3 position-relative" style="text-align: left;" href="{{ route('seller.notification.show', $notification->id) }}">
