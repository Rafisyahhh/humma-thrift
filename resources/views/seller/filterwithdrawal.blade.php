    ...
    @forelse ($withdrawals as $withdrawal)
        <div class="table-body">
            ...
            <div class="table-item">
                ...
                @else
                    <a href="https://api.whatsapp.com/send?phone=6285707062531&text=Permisi%20saya%20{{ urlencode($withdrawal->first()->store->name) }}%20melakukan%20penarikan%20dana%20sejumlah%20{{ urlencode('Rp. ' . number_format($withdrawal->amount, 0, ',', '.')) }}%20pada%20tanggal%20{{ urlencode($withdrawal->created_at->format('d-m-Y')) }}%20memohon%20untuk%20segera%20disetujui"
