...
@section('content')
    <div class="wishlist">
        <div class="d-flex justify-content-between align-items-center">
            <h5>Data Produk</h5>
            <a href="{{ route('seller.product.create') }}" class="shop-btn float-left m-0" style="color: white;">Tambah
                Produk</a>
        </div>
        ...
        <div class="cart-section wishlist-section row gy-5">
            ...
            @empty
                <div class="col-lg-4 col-sm-6 mx-auto">
                    <p class="text-center" style="font-size: 16px; margin-top: 2rem;">Produk Belum Tersedia</p>
                </div>
            @endforelse
                            ...
                            <div class="product-description">
                                ...
                                <div class="price">
                                    <p class="new-price fs-4 fw-bold">Rp.
                                        {{ number_format($item->bid_price_start, 2, ',', '.') }}-Rp.
                                        {{ number_format($item->bid_price_end, 2, ',', '.') }}</p>
                                </div>
                            </div>
                        </div>
                        <div class="product-cart-btn">
                            <a role="button" class="product-btn" data-bs-toggle="modal"
                                data-bs-target="#detailLelang">Lelang</a>
                                ...
                                <div class="product-info-content" data-aos="fade-left">
                                    ...
                                    <div class="product-details">
                                        <table>
                                            ...
                                            <tr>
                                                <th colspan="2"><span class="inner-text">Lorem ipsum dolor sit amet
                                            ...
                                            <tr>
                                                <th>Status</th>
                                                <td><span class="inner-status" style="color: red">Diterima</span></td>
                                            </tr>
                                        </table>
                                    </div>
                                    <hr>
