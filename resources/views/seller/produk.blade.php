        ...
        <div class="review-form m-0" style="height: 80%; width: 95rem;">
          ...
          <section class="product product-info" style="width:85rem; height:60%;">
            <div class="row ">
                      ...
                      <div class="product-wrapper" data-aos="fade-up">
                        ...
                        <div class="product-info">
                          <div class="product-description">
                            ...
                            <div class="price">
                              <span
                                class="new-price text-nowrap">{{ $item->bid_price_start }}-{{ $item->bid_price_end }}</span>
                            </div>
                          </div>
                        </div>
                        <div class="product-cart-btn">
                            ...
                            <div class="product-info-content" data-aos="fade-left">
                              ...
                              <div class="product-details">
                                <table>
                                  ...
                                  <tr>
                                    <th colspan="2"><span class="inner-text">Lorem ipsum dolor sit amet consectetur
                                        adipisicing elit. Eveniet cumque perferendis libero
              ...
              {{-- LELANG --}}
              <div class="modal fade" id="detailLelang" tabindex="-1" aria-labelledby="exampleModalLabel"
