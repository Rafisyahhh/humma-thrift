                                        ...
                                        <span style="background-color: unset">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="21" height="21"
                                                ...
                                                <circle cx="13.33" cy="29.75" r="2.25" fill="#1b336b"
                                                    class="clr-i-outline clr-i-outline-path-1" stroke="#1b336b"
                                                    stroke-width="1" />
                                                <circle cx="27" cy="29.75" r="2.25" fill="#1b336b"
                                                    class="clr-i-outline clr-i-outline-path-2" stroke="#1b336b"
                                                    stroke-width="1" />
                                                <path fill="#1b336b"
                                                    ...
                                                    class="clr-i-outline clr-i-outline-path-3" stroke="#1b336b"
                                                    stroke-width="1" />
                        ...
                        <div class="product-wrapper" data-aos="fade-up">
                            <div class="product-img" style="background-color:black">
                                ...
                                <div class="product-cart-items dropstart"
                                    ...
                                    <ul class="dropdown-menu">
                                        <li>
                                            <form action="{{ route('seller.productauction.edit', $item->id) }}"
                                                method="get">
                                                <button class="dropdown-item" type="submit">Edit</button>
                                            </form>
                                        </li>
                                        <li>
                                            <form action="{{ route('seller.productauction.destroy', $item->id) }}"
                                                method="post">
                                                @csrf
                                                @method('DELETE')
                                                <button class="dropdown-item" type="submit">Hapus</button>
                           ...
                           data-bs-target="#detailLelang{{ $item->id }}">Lelang</a> --}}
                            ...
                            <div class="favorite-cart-container">
                                <a role="button" data-bs-toggle="modal"
                                    data-bs-target="#lfavoriteModal{{ $item->id }}" class="favorite-cart-icon"
                                                ...
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title"
                                                            id="lfavoriteModalLabel{{ $item->id }}">
                                                            {{ $item->title }}</h5>
                                                        <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                            aria-label="Close"></button>
                                                    </div>
                ...
                <table style="width:120rem;">
                    <tbody>
                        ...
                        @foreach ($auctions as $item)
                            @php
                                $anyTrueStatus = App\Models\auctions::where(
                                    'product_auction_id',
                                    $item->product_auction_id,
                                )
                                    ->where('status', 1)
                                    ->exists();
                            ...
                            @endphp
                            <tr class="table-row ticket-row"
                                style="{{ $statusTrue ? 'background-color: #edeaea;' : '' }}">
                                <td class="table-wrapper">
                                    <div class="table-wrapper-center">
                                        <h5 class="heading">{{ $loop->iteration }}</h5>
                                    </div>
                                ...
                                <td class="table-wrapper">
                                    <div class="table-wrapper-center">
                                        <form action="{{ route('seller.auction.updatelelang', $item->id) }}"
                                            method="POST">
                                            @csrf
                                            @method('PUT')

                                            <input type="hidden" name="product_auction_id"
                                                value="{{ $item->product_auction_id }}">
                                            <input type="radio" onchange="submitForm(this)" class="btn-check"
                                                name="status" id="status-{{ $item->id }}" value="1"
                                                {{ $statusTrue ? 'checked' : '' }} autocomplete="off"
