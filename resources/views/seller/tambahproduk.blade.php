...
<style>
    ...
    .dz-preview {
        width: calc(33.333% - 10px); /* 3 items per row with spacing */
...
<div class="col-lg-9 justify-content-center">
                                        ...
                                        <div class="row gy-5">
                                            <div class="col-sm-6">
                                                <div class="card phone" onclick="selectCard('phone')" style="height: 80px">
                                                    <input type="radio" id="phone" name="contact" class="radio-input" style="display: none">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="card email" onclick="selectCard('email')" style="height: 80px">
                                                    <input type="radio" id="email" name="contact" class="radio-input" style="display: none">
                                                    <div class="wrapper-content">
                                                        <p>Lelang</p>
                                                    </div>
                                                </div>
    ...
    <form action="{{ route('seller.produkauction.store') }}" id="formDropzone" method="post" enctype="multipart/form-data">
        <div class="review-form">
            <div class="account-inner-form">
                <div class="row">
                    <div class="col-md-6 mb-3">
