              ...
              <div class="col-lg-12">
                <div class="product-sorting-section p-0">
                  ...
                  <div class= "btn-group mt-2">
                    <div class="dropdown">
                      <a class="css-71s6qs d-flex align-items-center gap-2" href="#" role="button"
                      ...
                      <div class="btn-group">
                        <div class="dropdown">
                          <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton"
                            ...
                            <li><a class="dropdown-item" href="#" style="font-size: 16px;">Terbaru Disimpan</a></li>
                            <hr>
                            <li><a class="dropdown-item" href="#" style="font-size: 16px;">Terlama Disimpan</a></li>
                            <hr>
                    ...
                    <div class="product-img position-relative">
                      ...
                      <div class="dropdown position-absolute" style="right: 0; top: 0;">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="wishlistDropdown">
                          <li>
                            <form action="{{ route('destroyProduct.destroy', $item->id) }}" method="POST"
