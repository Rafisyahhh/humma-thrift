                                        ...
                                        <label for="payment-method-{{ $loop->index }}" class="radio-button-labels">
                                            <div class="d-flex flex-column align-items-center mt-3">
                                                ...
                                                <div class="text-center">
                                                    ...
                                                    <p class="fs-5">
                                                        @currency($item->flat == null ? $item->percent/100*$product_auction->sum('price') : $item->flat)
                                                    </p>
                                                </div>
                                            </div>
                                        </label>
                                    ...
                                    <div class="col-md-6">
                                        <p class="fw-bold" style="font-size: 17px; margin: 0">
                                            <b style="font-size: 17px">
                                                {{ $product_auction->first()->userstore->name }}

                                                @if ($product_auction->first()->userstore->user->phone)
                ...
                <div class="account-section billing-section">
                    ...
                    <div class="order-summery">
                        ...
                        <div class="subtotal product-total">
                            ...
                            <h5 class="wrapper-heading" style="font-size: 17px;">
                                @currency($product_auction->sum('price'))
                            </h5>
                        </div>
                        <div class="subtotal product-total">
                        ...
                        <div class="subtotal product-total">
                            ...
                            <h5 class="wrapper-heading" style="font-size: 17px;">@currency($biaya_admin->biaya_admin)</h5>
                        </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function calculateTotal(productPrice, adminfeeFlat, adminfeePercent) {
                ...
                const total = productPrice + adminFee + {{ $biaya_admin->biaya_admin }};
