                        ...
                        <div class="service-img">
                            <span>
                                <svg width="32" height="37" viewBox="0 0 36 37" fill="none"
                                    ...
                                    <path d="M1 1H5.63636V24.1818H35" stroke=" #ffffff" stroke-width="2"
                                    ...
                                    <path
                                        ...
                                        stroke=" #ffffff" stroke-width="2" stroke-miterlimit="10"
                                        stroke-linecap="square" />
                                    <path d="M34.9982 1H11.8164V18H34.9982V1Z" stroke=" #ffffff" stroke-width="2"
                                        stroke-miterlimit="10" stroke-linecap="square" />
                                    <path d="M11.8164 7.17969H34.9982" stroke=" #ffffff" stroke-width="2"
                                        stroke-miterlimit="10" stroke-linecap="square" />
                                </svg>
                            </span>
                        </div>
                            ...
                            <span>
                                <svg width="32" height="37" viewBox="0 0 32 34" fill="none"
                                    ...
                                    <path
                                        ...
                                        stroke=" #ffffff" stroke-width="2" stroke-miterlimit="10" />
                                    <path d="M30.7 2L29.5 10.85L20.5 9.65" stroke=" #ffffff" stroke-width="2"
                                        stroke-miterlimit="10" stroke-linecap="square" />
                                </svg>
                            </span>
                        </div>
                        ...
                        <div class="service-img">
                            <span>
                                <svg width="32" height="37" viewBox="0 0 32 38" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path d="M22.6654 18.668H9.33203V27.0013H22.6654V18.668Z" stroke=" #ffffff"
                        ...
                        <div class="service-img">
                            <span>
                                <svg width="32" height="37" viewBox="0 0 32 35" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path d="M7 13H5.5C2.95 13 1 11.05 1 8.5V1H7" stroke=" #ffffff"
                                        stroke-width="2" stroke-miterlimit="10" />
                                    <path d="M25 13H26.5C29.05 13 31 11.05 31 8.5V1H25" stroke=" #ffffff"
                                        stroke-width="2" stroke-miterlimit="10" />
                                    <path d="M16 28V22" stroke=" #ffffff" stroke-width="2"
