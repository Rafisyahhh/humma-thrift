                ...
                <span>
                  <svg width="35" height="27" viewBox="0 0 35 27" fill="none"
                    ...
                    <path
                      ...
                      fill="#6E6D79" />
                    <circle cx="26.7662" cy="8" r="8" fill="rgb(167, 146, 119)" />
                    <path
            ...
            <div class="header-cart">
                ...
                <span>
                  <svg width="35" height="28" viewBox="0 0 35 28" fill="none"
                    ...
                    <path
                      ...
                      fill="#6E6D79" />
                    <circle cx="26.9523" cy="8" r="8" fill="rgb(167, 146, 119)" />
                    <path
              ...
              <div class="cart-submenu">
                <div class="cart-wrapper-item">
                  ...
                  <div class="wrapper">
                    <div class="wrapper-item">
                      <div class="wrapper-img">
                        <img
                          src="{{ asset('template-assets/front/assets/images/homepage-one/product-img/product-img-2.webp') }}"
                          alt="img">
                      </div>
                      <div class="wrapper-content">
                ...
                <div class="cart-wrapper-section">
                  ...
                  <div class="cart-btn">
                    <a href="cart.html" class="shop-btn view-btn">Lihat Keranjang</a>
                    <a href="checkout.html" class="shop-btn checkout-btn">Beli Sekarang</a>
                  </div>
                </div>
              </div>
            </div>
                  ...
                  <div class="dropdown-item d-flex justify-content-between align-items-center">
                    <div class="dropdown-list-item d-flex">
                      <span class="dropdown-img">
                        <img
                          src="{{ asset('template-assets/front/assets/images/homepage-one/category-img/dresses.webp') }}"
                          alt="dress">
                      </span>
      ...
      <div class="container">
        <div class="header-nav">
                  ...
                  <a href="product-sidebar.html">
                    <div class="dropdown-item d-flex justify-content-between align-items-center">
                      <div class="dropdown-list-item d-flex">
                        <span class="dropdown-img">
                          <img
                            src="{{ asset('template-assets/front/assets/images/homepage-one/category-img/bags.webp') }}"
                            alt="Bags">
                        </span>
                        <span class="dropdown-text">
                          Tas
                  ...
                  <a href="product-sidebar.html">
                    <div class="dropdown-item d-flex justify-content-between align-items-center">
                      <div class="dropdown-list-item d-flex">
                        <span class="dropdown-img">
                          <img
                            src="{{ asset('template-assets/front/assets/images/homepage-one/category-img/sweaters.webp') }}"
                            alt="sweaters">
                        </span>
                        <span class="dropdown-text">
                          Sweaters
                  ...
                  <a href="product-sidebar.html">
                    <div class="dropdown-item d-flex justify-content-between align-items-center">
                      <div class="dropdown-list-item d-flex">
                        <span class="dropdown-img">
                          <img
                            src="{{ asset('template-assets/front/assets/images/homepage-one/category-img/shoes.webp') }}"
                            alt="sweaters">
                        </span>
                        <span class="dropdown-text">
                          Sepatu Boot
                  ...
                  <a href="product-sidebar.html">
                    <div class="dropdown-item d-flex justify-content-between align-items-center">
                      <div class="dropdown-list-item d-flex">
                        <span class="dropdown-img">
                          <img
                            src="{{ asset('template-assets/front/assets/images/homepage-one/category-img/gift.webp') }}"
                            alt="gift">
                        </span>
                        <span class="dropdown-text">
                          Hadiah
                  ...
                  <a href="product-sidebar.html">
                    <div class="dropdown-item d-flex justify-content-between align-items-center">
                      <div class="dropdown-list-item d-flex">
                        <span class="dropdown-img">
                          <img
                            src="{{ asset('template-assets/front/assets/images/homepage-one/category-img/sneakers.webp') }}"
                            alt="sneakers">
                        </span>
                        <span class="dropdown-text">
                          Sneakers
                  ...
                  <a href="product-sidebar.html">
                    <div class="dropdown-item d-flex justify-content-between align-items-center">
                      <div class="dropdown-list-item d-flex">
                        <span class="dropdown-img">
                          <img
                            src="{{ asset('template-assets/front/assets/images/homepage-one/category-img/watch.webp') }}"
                            alt="watch">
                        </span>
                        <span class="dropdown-text">
                          Jam Tangan
                  ...
                  <a href="product-sidebar.html">
                    <div class="dropdown-item d-flex justify-content-between align-items-center">
                      <div class="dropdown-list-item d-flex">
                        <span class="dropdown-img">
                          <img
                            src="{{ asset('template-assets/front/assets/images/homepage-one/category-img/ring.webp') }}"
                            alt="ring">
                        </span>
                        <span class="dropdown-text">
                          Cincin
                  ...
                  <a href="product-sidebar.html">
                    <div class="dropdown-item d-flex justify-content-between align-items-center">
                      <div class="dropdown-list-item d-flex">
                        <span class="dropdown-img">
                          <img
                            src="{{ asset('template-assets/front/assets/images/homepage-one/category-img/cap.webp') }}"
                            alt="cap">
                        </span>
                        <span class="dropdown-text">
                          Topi
                  ...
                  <a href="product-sidebar.html">
                    <div class="dropdown-item d-flex justify-content-between align-items-center">
                      <div class="dropdown-list-item d-flex">
                        <span class="dropdown-img">
                          <img
                            src="{{ asset('template-assets/front/assets/images/homepage-one/category-img/glass.webp') }}"
                            alt="glass">
                        </span>
                        <span class="dropdown-text">
                          Kacamata Hitam
          ...
          <div class="header-vendor-btn">
            <a href="{{ route('registstore') }}" class="shop-btn">
              <span class="list-text shop-text">Menjadi Penjual</span>
              <span class="icon">
