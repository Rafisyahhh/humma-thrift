    ...
    {{-- <div class="modal fade" tabindex="-1" id="editModal">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('admin.about.update', ':id:') }}" method="POST"
                        ...
                        <div class="mb-3">
                            <label for="image" class="form-label">Gambar</label>
                            <input type="file" class="form-control @error('image_update') is-invalid @enderror"
                    ...
                    <div class="modal-body">
                        <form action="{{ route('admin.about.update', ) }}" method="POST"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="file" class="form-control @error('image_update') is-invalid @enderror"
                                    id="image" name="image_update" />
                                <img src="{{ asset("storage/$about->image") }}" class="w-100 mt-3 rounded-3"
                                    alt="image" id="image_placeholder" />
                                @error('image_update')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
