                ...
                <div class="d-flex align-items-end row">
                    ...
                    <div class="col-5 text-center text-sm-left">
                        <div class="card-body pb-0 px-0 px-md-4">
                            <img src="{{ asset('template-assets/admin/assets/img/illustrations/card-advance-sale.png') }}"
            ...
            <div class="card h-100">
                ...
                <div class="card-body">
                    <ul class="p-0 m-0">
                        ...
                        <li class="d-flex">
                            <div class="me-3">
                                <img src="{{ asset('template-assets/admin/assets/img/products/play-station.png') }}"
